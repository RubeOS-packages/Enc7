...
interface VaultHomePageProps {
  onNavigate: (page: Page) => void;
}

const VaultHomePage: React.FC<VaultHomePageProps> = ({ onNavigate }) => {
  return (
    <div className="w-full max-w-2xl mx-auto text-center">
      <header className="mb-10">
        <svg className="w-24 h-24 mx-auto text-cyan-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
        <h1 className="text-5xl font-bold text-white tracking-tight">Secure Vault</h1>
        <p className="text-gray-400 mt-4 text-lg">Real, client-side file encryption. Your data never leaves your device.</p>
      </header>

      <main className="space-y-6 bg-slate-800/50 border border-slate-700 rounded-lg shadow-xl p-8">
        <p className="text-gray-300">
            All encryption and decryption operations are performed locally in your browser. No data is ever sent to a server.
        </p>
